...
//             <h1 className="text-2xl sm:text-4xl font-pixel text-[#ffd700]">Player Dashboard</h1>
//             <div className="flex gap-4">
//               <button
//                   onClick={() => setShowSettingsModal(true)}
//                   className="p-2 rounded-lg bg-[#3a3a3a] hover:bg-[#4a4a4a] transition-colors"
...
//             <motion.div
//                 whileHover={{ scale: 1.02 }}
//                 className="bg-[#3a3a3a] p-4 sm:p-6 rounded-lg pixel-border"
//             >
//               <div className="flex items-center gap-3 mb-4">
//                 <User className="w-6 sm:w-8 h-6 sm:h-8 text-[#ffd700]" />
//                 <h2 className="text-lg sm:text-xl font-pixel text-white">{user?.name}</h2>
//               </div>
//               <div className="space-y-2">
//                 <p className="text-sm sm:text-base text-[#ffd700] font-pixel">Total XP: {user?.totalXP || 0}</p>
//                 <p className="text-sm sm:text-base text-white font-pixel">Memory Level: {memoryLevel}</p>
//               </div>
//             </motion.div>
//           </div>
//
...
//             <motion.div
//                 whileHover={{ scale: 1.02 }}
//                 className="bg-[#3a3a3a] p-4 sm:p-6 rounded-lg pixel-border cursor-pointer"
//                 onClick={() => navigate('/memoryGame')}
//             >
//               <div className="flex items-center gap-3 mb-4">
//                 <Brain className="w-6 sm:w-8 h-6 sm:h-8 text-[#ffd700]" />
//                 <h2 className="text-lg sm:text-xl font-pixel text-white">Memory Match</h2>
//               </div>
//               <p className="text-sm sm:text-base text-[#ffd700] font-pixel mb-4">Master French vocabulary!</p>
//               <div className="flex justify-between items-center">
//                 <span className="text-sm sm:text-base text-white font-pixel">High Score: {memoryHighScore}</span>
//                 <button className="px-3 py-1 sm:px-4 sm:py-2 bg-[#ffd700] text-[#2b2b2b] rounded font-pixel text-sm sm:text-base">
//                   Play
//                 </button>
//               </div>
//             </motion.div>
...
//             >
//               <div className="flex items-center gap-3 mb-4">
//                 <Gamepad2 className="w-6 sm:w-8 h-6 sm:h-8 text-[#ffd700]" />
//                 <h2 className="text-lg sm:text-xl font-pixel text-white">DinoLingo</h2>
//               </div>
//               <p className="text-sm sm:text-base text-[#ffd700] font-pixel mb-4">Learn Spanish with our Dino!</p>
//               <div className="flex justify-between items-center">
//                 <span className="text-sm sm:text-base text-white font-pixel">Unlock new words</span>
//                 <button className="px-3 py-1 sm:px-4 sm:py-2 bg-[#ffd700] text-[#2b2b2b] rounded font-pixel text-sm sm:text-base">
//                   Play
//                 </button>
//               </div>
...
//             >
//               <div className="flex items-center gap-3 mb-4">
//                 <Users className="w-6 sm:w-8 h-6 sm:h-8 text-[#ffd700]" />
//                 <h2 className="text-lg sm:text-xl font-pixel text-white">Multiplayer</h2>
//               </div>
//               <p className="text-sm sm:text-base text-[#ffd700] font-pixel mb-4">Play with friends!</p>
//               <div className="flex justify-between items-center">
//                 <span className="text-sm sm:text-base text-white font-pixel">Real-time matches</span>
//                 <button className="px-3 py-1 sm:px-4 sm:py-2 bg-[#ffd700] text-[#2b2b2b] rounded font-pixel text-sm sm:text-base">
//                   Play
//                 </button>
//               </div>
...
//                       animate={{ scale: 1 }}
//                       exit={{ scale: 0.9 }}
//                       className="bg-[#3a3a3a] p-6 sm:p-8 rounded-lg max-w-md w-full"
//                   >
//                     <h2 className="text-xl sm:text-2xl font-pixel text-[#ffd700] mb-6">Confirm Logout</h2>
//                     <p className="text-sm sm:text-base text-white font-pixel mb-8">Are you sure you want to logout?</p>
//                     <div className="flex gap-4">
//                       <button
//                           onClick={handleLogout}
//                           className="flex-1 px-4 py-2 bg-red-500 text-white rounded font-pixel text-sm sm:text-base"
//                       >
//                         Logout
//                       </button>
//                       <button
//                           onClick={() => setShowLogoutModal(false)}
//                           className="flex-1 px-4 py-2 bg-[#4a4a4a] text-white rounded font-pixel text-sm sm:text-base"
//                       >
//                         Cancel
//                       </button>
//                     </div>
...
//                       className="bg-[#3a3a3a] p-6 sm:p-8 rounded-lg max-w-md w-full"
//                   >
//                     <h2 className="text-xl sm:text-2xl font-pixel text-[#ffd700] mb-6">Settings</h2>
//
//                     {isEditing ? (
//                         <form onSubmit={handleUpdateProfile} className="space-y-4">
//                           <div>
//                             <label className="block text-white font-pixel mb-2 text-sm">Name</label>
//                             <input
//                                 type="text"
//                                 value={formData.name}
//                                 onChange={(e) => setFormData({ ...formData, name: e.target.value })}
//                                 className="w-full px-4 py-2 rounded bg-[#2b2b2b] text-white text-sm sm:text-base"
//                             />
//                           </div>
//                           <div>
//                             <label className="block text-white font-pixel mb-2 text-sm">Email</label>
//                             <input
//                                 type="email"
//                                 value={formData.email}
//                                 onChange={(e) => setFormData({ ...formData, email: e.target.value })}
...
//                           </div>
//                           <div>
//                             <label className="block text-white font-pixel mb-2 text-sm">New Password</label>
//                             <input
//                                 type="password"
//                                 value={formData.password}
//                                 onChange={(e) => setFormData({ ...formData, password: e.target.value })}
...
//                             <button
//                                 type="submit"
//                                 className="flex-1 px-4 py-2 bg-[#ffd700] text-[#2b2b2b] rounded font-pixel text-sm sm:text-base"
//                             >
//                               Save Changes
//                             </button>
//                             <button
...
//                           <button
//                               onClick={() => setIsEditing(true)}
//                               className="w-full px-4 py-2 bg-[#ffd700] text-[#2b2b2b] rounded font-pixel text-sm sm:text-base"
//                           >
//                             Edit Profile
//                           </button>
//                           <button
//                               onClick={() => setShowDeleteModal(true)}
//                               className="w-full px-4 py-2 bg-red-500 text-white rounded font-pixel text-sm sm:text-base"
//                           >
//                             Delete Account
//                           </button>
//                           <button
//                               onClick={() => setShowSettingsModal(false)}
//                               className="w-full px-4 py-2 bg-[#4a4a4a] text-white rounded font-pixel text-sm sm:text-base"
//                           >
//                             Close
//                           </button>
//                         </div>
...
//                       className="bg-[#3a3a3a] p-6 sm:p-8 rounded-lg max-w-md w-full"
//                   >
//                     <h2 className="text-xl sm:text-2xl font-pixel text-red-500 mb-6">Delete Account</h2>
//                     <p className="text-sm sm:text-base text-white font-pixel mb-8">
//                       Are you sure you want to delete your account? This action cannot be undone.
//                     </p>
//                     <div className="flex gap-4">
//                       <button
