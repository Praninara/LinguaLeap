  ...
  return (
      ...
      >
        <motion.div
            initial={{ scale: 0.9, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            className="bg-[#3a3a3a] p-4 sm:p-8 rounded-lg pixel-border max-w-md w-full"
        >
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="text-2xl sm:text-3xl font-pixel text-[#ffd700] mb-4">Game Over!</h2>
            <div className="space-y-2 font-pixel text-sm sm:text-base">
              <p className="text-white">Level Reached: {level}</p>
              <p className="flex items-center justify-center gap-2">
                <Trophy className="w-4 sm:w-5 h-4 sm:h-5 text-[#ffd700]" />
                <span className="text-white">Final Score: {score}</span>
              </p>
            </div>
          </div>
