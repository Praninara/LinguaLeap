...
//   switch (language) {
//     case 'hindi':
//       prompt = `Generate ${count} Hindi word pairs for language learning. Format as JSON array:
//       [
//         {
//           "word": "<Hindi word in Devanagari script>",
//           "translation": "<english translation>",
//           "alternativeTranslations": ["<romanized hindi>", "<alternative translations>"]
//         }
//       ]
//
//       Include both Devanagari script and romanized versions in alternativeTranslations.
//       Example: { "word": "नमस्ते", "translation": "hello", "alternativeTranslations": ["namaste", "greetings"] }`;
//       break;
//
//     case 'telugu':
//       prompt = `Generate ${count} Telugu word pairs for language learning. Format as JSON array:
//       [
//         {
//           "word": "<Telugu word in Telugu script>",
//           "translation": "<english translation>",
//           "alternativeTranslations": ["<romanized telugu>", "<alternative translations>"]
//         }
//       ]
//
//       Include both Telugu script and romanized versions in alternativeTranslations.
//       Example: { "word": "నమస్కారం", "translation": "hello", "alternativeTranslations": ["namaskaram", "greetings"] }`;
//       break;
//
//     case 'kannada':
//       prompt = `Generate ${count} Kannada word pairs for language learning. Format as JSON array:
//       [
//         {
//           "word": "<Kannada word in Kannada script>",
//           "translation": "<english translation>",
//           "alternativeTranslations": ["<romanized kannada>", "<alternative translations>"]
//         }
//       ]
//
//       Include both Kannada script and romanized versions in alternativeTranslations.
//       Example: { "word": "ನಮಸ್ಕಾರ", "translation": "hello", "alternativeTranslations": ["namaskara", "greetings"] }`;
//       break;
//
//     default:
//       prompt = `Generate ${count} ${language} word pairs for language learning. Format as JSON array:
//       [
//         {
//           "word": "<${language} word>",
//           "translation": "<english translation>",
...
const FALLBACK_WORD_PAIRS = {
  ...
  telugu: [
    { word: "నమస్కారం", translation: "Hello", alternativeTranslations: ["namaskaram", "greetings"] },
    { word: "ధన్యవాదాలు", translation: "Thank you", alternativeTranslations: ["dhanyavaadaalu"] },
    { word: "శుభోదయం", translation: "Good morning", alternativeTranslations: ["shubhodayam"] },
    { word: "శుభరాత్రి", translation: "Good night", alternativeTranslations: ["shubharaatri"] },
    { word: "అవును", translation: "Yes", alternativeTranslations: ["avunu"] },
    { word: "కాదు", translation: "No", alternativeTranslations: ["kaadhu"] },
    { word: "దయచేసి", translation: "Please", alternativeTranslations: ["dayachesi"] },
    { word: "క్షమించండి", translation: "Sorry", alternativeTranslations: ["kshamincandi"] },
    { word: "భోజనం", translation: "Food", alternativeTranslations: ["bhojanam"] },
    { word: "నీళ్ళు", translation: "Water", alternativeTranslations: ["neellu"] }
  ],
  hindi: [
    { word: "नमस्ते", translation: "Hello", alternativeTranslations: ["namaste", "greetings"] },
    { word: "धन्यवाद", translation: "Thank you", alternativeTranslations: ["dhanyavaad"] },
    { word: "शुभ प्रभात", translation: "Good morning", alternativeTranslations: ["shubh prabhat"] },
    { word: "शुभ रात्रि", translation: "Good night", alternativeTranslations: ["shubh ratri"] },
    { word: "हाँ", translation: "Yes", alternativeTranslations: ["haan"] },
    { word: "नहीं", translation: "No", alternativeTranslations: ["nahi"] },
    { word: "कृपया", translation: "Please", alternativeTranslations: ["kripya"] },
    { word: "माफ़ कीजिये", translation: "Sorry", alternativeTranslations: ["maaf kijiye"] },
    { word: "खाना", translation: "Food", alternativeTranslations: ["khaana"] },
    { word: "पानी", translation: "Water", alternativeTranslations: ["paani"] }
  ],
  kannada: [
    { word: "ನಮಸ್ಕಾರ", translation: "Hello", alternativeTranslations: ["namaskara", "greetings"] },
    { word: "ಧನ್ಯವಾದಗಳು", translation: "Thank you", alternativeTranslations: ["dhanyavaadagalu"] },
    { word: "ಶುಭೋದಯ", translation: "Good morning", alternativeTranslations: ["shubhodaya"] },
    { word: "ಶುಭರಾತ್ರಿ", translation: "Good night", alternativeTranslations: ["shubharatri"] },
    { word: "ಹೌದು", translation: "Yes", alternativeTranslations: ["haudu"] },
    { word: "ಇಲ್ಲ", translation: "No", alternativeTranslations: ["illa"] },
    { word: "ದಯವಿಟ್ಟು", translation: "Please", alternativeTranslations: ["dayavittu"] },
    { word: "ಕ್ಷಮಿಸಿ", translation: "Sorry", alternativeTranslations: ["kshamisi"] },
    { word: "ಊಟ", translation: "Food", alternativeTranslations: ["oota"] },
    { word: "ನೀರು", translation: "Water", alternativeTranslations: ["neeru"] }
  ]
};
