      ...
      <div className="min-h-screen bg-[#2b2b2b] p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-[#3a3a3a] p-8 rounded-lg pixel-border mb-8"
          >
            <h2 className="text-xl font-pixel text-[#ffd700] mb-6">How to Play</h2>
            <ul className="space-y-4 text-white font-pixel">
              <li>🎮 Challenge players in real-time word guessing</li>
              <li>🌟 Earn XP for correct guesses</li>
              <li>🏆 Compete for top spots on the leaderboard</li>
              <li>🤝 Play with friends or find random opponents</li>
            </ul>
          </motion.div>
            ...
            >
              <div className="text-center">
                ...
                <h2 className="text-xl font-pixel text-white mb-4">
                  {isSearching ? 'Looking for players...' : 'Ready to find opponents?'}
                </h2>
                {!isSearching && (
                  <button
