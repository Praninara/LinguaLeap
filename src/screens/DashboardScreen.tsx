...
const DashboardScreen = () => {
  ...
  const [selectedGame, setSelectedGame] = useState<'memory' | 'dino' | 'multiplayer' | null>(null);
  ...
  const handleGameSelect = (game: 'memory' | 'dino' | 'multiplayer') => {
  ...
  const handleLanguageSelect = (language: Language) => {
    ...
    switch (selectedGame) {
      case 'memory':
        navigate('/memoryGame', { state: { language } });
        break;
      case 'dino':
        navigate('/dinoGame', { state: { language } });
        break;
      case 'multiplayer':
        navigate('/multiplayer', { state: { language } });
        break;
    }
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-[#ffd700] font-pixel mb-4">Master vocabulary!</p>
          ...
          >
            ...
            <p className="text-[#ffd700] font-pixel mb-4">Learn with our Dino!</p>
            <div className="flex justify-between items-center">
